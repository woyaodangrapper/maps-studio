...
//泵体事件
function _PumpStructure(){
  _("example_PumpStructure")
}
  ...
  (function () {
    ...
    function _animation() {
      ...
      var tileset =  G.aGLTF(viewer,{
        ...
        scale:2,
        position:{
          x:120.26637384753343,
          y:30.2948741387893,
          z:28
        }
      });
      var GLTF =  G.aGLTF(viewer,{
        url: '/assets/model/透明三角.gltf',
        scale:2,
        position:{
          x:120.26637384753343,
          y:30.2948741387893,
      ...
      /**viewer.OffsetAlarmEffect = */ setInterval(function () {
        ...
        var origin = Cesium.Cartesian3.fromDegrees(120.26637384753343, 30.2948741387893, 28 + heightOffsetAlarmEffect);
        var modelMatrix = Cesium.Transforms.headingPitchRollToFixedFrame(origin, hpr);
        tileset.modelMatrix = modelMatrix;
        GLTF.modelMatrix = modelMatrix;
        model.position = Cesium.Cartesian3.fromDegrees(120.26637384753343, 30.2948741387893, 32 + heightOffsetAlarmEffect);
      }, 20);
